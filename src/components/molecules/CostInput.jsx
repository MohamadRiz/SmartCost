...
const CostInput = ({ fuelPrice, maintenancePrice, setFuelPrice, setMaintenancePrice, driverFee,
  setDriverFee,depreciationCost,setDepreciationCost, tolPrice, setTolPrice }) => (
  <div className="grid grid-cols-2 gap-4 mt-4">
    ...
    <InputField label="🛣 Biaya TOL" value={tolPrice} onChange={(e) => setTolPrice(Number(e.target.value))} />
